...
# ggsave(filename=here("output", "AMCE.png") ,
...
# ggsave(filename=here("output", "AMCE_crime_vict.png") ,
#               width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "AICE_vict_proposal.png") ,
#         width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "AICE_vict_occupation.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "AMCE_police_vict.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "AICE_vict_pol_proposal.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# save complete data
#write_csv(conjoint_data, here("data", "data_conjoint.csv"))
...
# 
# ggsave(filename=here("output", "conjoint_crime_victim.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggplot(mef_fo, 
  ...
  facet_wrap(~treatment, ncol=2) 
# 
# ggsave(filename=here("output", "conjoint_crime_victim_occup.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "conjoint_crime_victim_quantile.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output","conjoint_crime_victim_occup_quantile.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_police_violence.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggplot(mef_fs, 
  ...
  labs(title="", 
       ...
       caption="Baseline Condition: Candidate Proposing Victims Oriented Policies ") +
  scale_fill_manual(  values=c("steelblue", "tomato2"), 
                      name="Contextual Exposure to Police Violence", 
                      guide=guide_legend(reverse=TRUE)) +
  # geom_segment(aes(x=2.8, xend=3.2, y=0.19, yend=0.19), size=.5, 
  #              alpha=.4) +
  # geom_segment(aes(x=3.2, xend=3.2, y=0.19, yend=0.185), size=.5, 
...
modelsummary(list("Crime Victimization"=mod_cv, 
              ...
              fmt = 3,
              output = here("output", "model_network_residuals_conjoint.tex"),
              stars = TRUE, 
              coef_map = new_names)
...
# ggsave(filename=here("output", "conjoint_fear_crime_ocup.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_laworder_preference_policy.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_laworder_preference_occup.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_laworder_preference_party.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_trust_police_policy.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_trustpolice_occup.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_trust_police_party.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "conjoint_income_policy.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_income_occup.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "conjoint_income_party.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
# ggsave(filename=here("output", "AMCE_gender.png") ,
#        width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "positive_partisanship.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "negative_partisanship.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "party_acie_proposal.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "party_acie_occupation.png"),
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
...
ggsave(filename=here("output", "occup_acie_proposal.png") ,
       width = 12, height = 8, units = "in", pointsize = 12, bg = "white")
