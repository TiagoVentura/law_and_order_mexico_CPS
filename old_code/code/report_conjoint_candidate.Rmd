...
my_theme <- theme(text = element_text(family = my_font, color = "#22211d"),
                  ...
                  plot.title = element_text(size = 14, face = "bold", family=my_font),
                  plot.subtitle = element_text(size=12, family=my_font),
                  axis.title.x = element_text(hjust=1, family=my_font, size=7),
