...
\makeatother
\definecolor{amaranth}{rgb}{0.82, 0.1, 0.26}
...
\hypersetup{breaklinks=true,
            ...
            colorlinks=true,
            citecolor=$if(citecolor)$$citecolor$$else$amaranth$endif$,
            urlcolor=$if(urlcolor)$$urlcolor$$else$amaranth$endif$,
            linkcolor=$if(linkcolor)$$linkcolor$$else$amaranth$endif$,
            pdfborder={0 0 0}}
